...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      <td>1</td>     
      <td><img src="<?php echo ADMIN_PUBLIC; ?>images/11.jpg" alt="" width="120" height="50" /></td>
      <td>首页焦点图</td>
      <td>描述文字....</td>
      <td>1</td>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="Adv/add">    
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <input type="file" name="banner_pic" class="button margin-left;" style="display:none;" id="fileField" size="28" data-validate="required:请选择缩略图"/>
