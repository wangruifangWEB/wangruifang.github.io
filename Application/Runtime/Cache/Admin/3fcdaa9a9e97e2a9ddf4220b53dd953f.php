                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="/personalBlog/Public/admin/images/passcode.jpg" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
                        </div>
                    </div>
                </div>
                <div style="padding:30px;"><input type="button" class="button button-block bg-main text-big input-big" value="登录" onclick="login.check()"></div>
            </div>
            </form>          
        </div>
    </div>
...
<script src="/personalBlog/Public/admin/js/login.js"></script>
</body>
</html>